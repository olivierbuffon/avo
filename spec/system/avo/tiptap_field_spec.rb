    ...
    context 'edit' do
      ...
      context 'tiptap editor' do
        context 'toolbar' do
          ...
          context 'history' do
            it 'has a history undo button' do
              visit "/admin/resources/products/#{product.id}/edit"

              expect(find('.tiptap__toolbar')).to have_css('.tiptap__button--undo')
            end

            it 'has a history redo button' do
              visit "/admin/resources/products/#{product.id}/edit"

              expect(find('.tiptap__toolbar')).to have_css('.tiptap__button--redo')
            end
          end
